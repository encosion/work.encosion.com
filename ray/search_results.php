    ...
    <div class="candidate-cards">
        ...
        <div class="candidate-card" data-candidate-id="1">
            ...
            <div class="job-history">
                <div class="job-item">
                    Senior Product Owner, Microsoft <span class="duration">(3y 2m)</span>
                </div>
                <div class="job-item">
                    Product Manager, Amazon <span class="duration">(2y 8m)</span>
                </div>
                <div class="job-item">
                    Product Analyst, Google <span class="duration">(2y 1m)</span>
                </div>
            </div>
            <div class="candidate-location">Wilmington, North Carolina, USA</div>
        </div>
        ...
        <div class="candidate-card" data-candidate-id="2">
            ...
            <div class="job-history">
                <div class="job-item">
                    Senior Product Owner, Google <span class="duration">(2y 6m)</span>
                </div>
                <div class="job-item">
                    Product Manager, Microsoft <span class="duration">(3y 1m)</span>
                </div>
                <div class="job-item">
                    Product Specialist, Salesforce <span class="duration">(2y 3m)</span>
                </div>
            </div>
            <div class="candidate-location">Raleigh, North Carolina, USA</div>
        </div>
        ...
        <div class="candidate-card" data-candidate-id="3">
            ...
            <div class="job-history">
                <div class="job-item">
                    Lead Product Owner, Amazon <span class="duration">(2y 4m)</span>
                </div>
                <div class="job-item">
                    Senior Product Owner, Google <span class="duration">(3y 2m)</span>
                </div>
                <div class="job-item">
                    Product Manager, Microsoft <span class="duration">(2y 7m)</span>
                </div>
            </div>
            <div class="candidate-location">Charlotte, North Carolina, USA</div>
        </div>
        ...
        <div class="candidate-card" data-candidate-id="4">
            ...
            <div class="job-history">
                <div class="job-item">
                    Senior Product Owner, Salesforce <span class="duration">(2y 8m)</span>
                </div>
                <div class="job-item">
                    Product Manager, Amazon <span class="duration">(3y 4m)</span>
                </div>
                <div class="job-item">
                    Product Analyst, Google <span class="duration">(2y 2m)</span>
                </div>
            </div>
            <div class="candidate-location">Durham, North Carolina, USA</div>
        </div>
        ...
        <div class="candidate-card" data-candidate-id="5">
            ...
            <div class="job-history">
                <div class="job-item">
                    Senior Product Owner, Microsoft <span class="duration">(2y 1m)</span>
                </div>
                <div class="job-item">
                    Product Manager, Salesforce <span class="duration">(3y 6m)</span>
                </div>
                <div class="job-item">
                    Product Coordinator, Google <span class="duration">(2y 4m)</span>
                </div>
            </div>
            <div class="candidate-location">Richmond, Virginia, USA</div>
        </div>
        ...
        <div class="candidate-card" data-candidate-id="6">
            ...
            <div class="job-history">
                <div class="job-item">
                    Lead Product Owner, Google <span class="duration">(1 year 11m)</span>
                </div>
                <div class="job-item">
                    Senior Product Owner, Amazon <span class="duration">(3y 3m)</span>
                </div>
                <div class="job-item">
                    Product Manager, Microsoft <span class="duration">(2y 8m)</span>
                </div>
            </div>
            <div class="candidate-location">Atlanta, Georgia, USA</div>
        </div>
        ...
        <div class="candidate-card" data-candidate-id="7">
            ...
            <div class="job-history">
                <div class="job-item">
                    Senior Product Owner, Amazon <span class="duration">(2y 3m)</span>
                </div>
                <div class="job-item">
                    Product Manager, Salesforce <span class="duration">(3y 1m)</span>
                </div>
                <div class="job-item">
                    Product Specialist, Google <span class="duration">(2y 5m)</span>
                </div>
            </div>
            <div class="candidate-location">Columbia, South Carolina, USA</div>
        </div>
        ...
        <div class="candidate-card" data-candidate-id="8">
            ...
            <div class="job-history">
                <div class="job-item">
                    Senior Product Owner, Salesforce <span class="duration">(1 year 10m)</span>
                </div>
                <div class="job-item">
                    Product Manager, Microsoft <span class="duration">(3y 2m)</span>
                </div>
                <div class="job-item">
                    Product Analyst, Amazon <span class="duration">(2y 6m)</span>
                </div>
            </div>
            <div class="candidate-location">Norfolk, Virginia, USA</div>
        </div>
        ...
        <div class="candidate-card" data-candidate-id="9">
            ...
            <div class="job-history">
                <div class="job-item">
                    Lead Product Owner, Microsoft <span class="duration">(1 year 8m)</span>
                </div>
                <div class="job-item">
                    Senior Product Owner, Google <span class="duration">(3y 4m)</span>
                </div>
                <div class="job-item">
                    Product Manager, Amazon <span class="duration">(2y 9m)</span>
                </div>
            </div>
            <div class="candidate-location">Charleston, South Carolina, USA</div>
        </div>
        ...
        <div class="candidate-card" data-candidate-id="10">
            ...
            <div class="job-history">
                <div class="job-item">
                    Senior Product Owner, Google <span class="duration">(2y 5m)</span>
                </div>
                <div class="job-item">
                    Product Manager, Salesforce <span class="duration">(3y 7m)</span>
                </div>
            </div>
            <div class="candidate-location">Jacksonville, Florida, USA</div>
        </div>
        ...
        <div class="candidate-card" data-candidate-id="11">
            ...
            <div class="job-history">
                <div class="job-item">
                    Senior Product Owner, Amazon <span class="duration">(1 year 7m)</span>
                </div>
                <div class="job-item">
                    Product Manager, Google <span class="duration">(3y 8m)</span>
                </div>
                <div class="job-item">
                    Product Specialist, Salesforce <span class="duration">(2y 4m)</span>
                </div>
            </div>
            <div class="candidate-location">Savannah, Georgia, USA</div>
        </div>
        ...
        <div class="candidate-card" data-candidate-id="12">
            ...
            <div class="job-history">
                <div class="job-item">
                    Lead Product Owner, Salesforce <span class="duration">(2y 2m)</span>
                </div>
                <div class="job-item">
                    Senior Product Owner, Microsoft <span class="duration">(3y 5m)</span>
                </div>
                <div class="job-item">
                    Product Manager, Amazon <span class="duration">(2y 7m)</span>
                </div>
            </div>
            <div class="candidate-location">Greenville, South Carolina, USA</div>
        </div>
        ...
        <div class="candidate-card" data-candidate-id="13">
            ...
            <div class="job-history">
                <div class="job-item">
                    Senior Product Owner, Microsoft <span class="duration">(1 year 9m)</span>
                </div>
                <div class="job-item">
                    Product Manager, Google <span class="duration">(3y 3m)</span>
                </div>
                <div class="job-item">
                    Product Analyst, Amazon <span class="duration">(2y 8m)</span>
                </div>
            </div>
            <div class="candidate-location">Asheville, North Carolina, USA</div>
        </div>
        ...
        <div class="candidate-card" data-candidate-id="14">
            ...
            <div class="job-history">
                <div class="job-item">
                    Senior Product Owner, Google <span class="duration">(2y 4m)</span>
                </div>
                <div class="job-item">
                    Product Manager, Salesforce <span class="duration">(3y 6m)</span>
                </div>
            </div>
            <div class="candidate-location">Knoxville, Tennessee, USA</div>
        </div>
    </div>
</div>
