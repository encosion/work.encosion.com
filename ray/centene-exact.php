...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (window.filterPanelManager) {
        console.log('Filter panel integrated with centene-exact.php');
    } else {
        // Fallback: check if filter panel exists and initialize
        setTimeout(() => {
            if (window.filterPanelManager) {
                console.log('Filter panel integrated with centene-exact.php (delayed)');
            }
        }, 100);
    }
    ...
    document.addEventListener('filterPanelOpened', function() {
        console.log('Filter panel opened on centene-exact page');
    });
    
    document.addEventListener('filterPanelClosed', function() {
        console.log('Filter panel closed on centene-exact page');
    });
});
</script>
