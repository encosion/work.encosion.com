...
$content = '<ul>
<li>As above plus:</li>
<li><strong>Close job role variations in the same domain:</strong> Industrial Equipment Technician, Manufacturing Technician, Production Technician, Facilities Maintenance Technician, Equipment Maintenance Specialist</li>
</ul>';
